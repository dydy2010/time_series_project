...
Looking at different available columns in the policy rate data we see that XXX
...
Looking at libor data we see that the average of the 3 Month Libor lower and upper limits is a good proxy for the SNB policy rate before 2020.
...
We do more data preparation so we can merge the two datasets together, the policy rates and the inflation rates. Then we create a timeseries object.
